...
public class LList<T> extends CustomClass<T> {
	...
	public T removeFirst() {
		// TODO Auto-generated method stub
		if (numberOfEntries > 0 && firstNode.next != null) {
	...
	public T removeLast() {
		...
		if (numberOfEntries > 1) {
			Node temp = getNodeAt(numberOfEntries - 1);
			T tempDat = temp.next.data;
			temp.next = null;
			numberOfEntries--;
			return tempDat;
	...
	public T getLast() {
		// TODO Auto-generated method stub
		if (numberOfEntries > 0)
			return getNodeAt(numberOfEntries).data;
		else
			throw new java.util.NoSuchElementException();
	}
	...
	public boolean remove(T anEntry) {
		...
		if (numberOfEntries > 1) {
			...
			boolean found = false;
			int count = 1;
			while (!found && count <= numberOfEntries && currentNode.next != null) {
		...
		} else if (numberOfEntries == 1 && firstNode.data.equals(anEntry)) {
			firstNode = null;
			numberOfEntries--;
			return true;
		}
